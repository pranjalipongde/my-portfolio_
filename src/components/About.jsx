...
const stats = [
  ...
  { value: "48hr", label: "Landing Page Delivery" },
];
        ...
        >
          ...
          <div className="p-6 sm:p-8">
            ...
            <p className="font-body text-charcoal/80 leading-relaxed text-[15px] mb-4">
              I'm an Electronics Engineer — but if you'd told me back then that
              I'd end up building websites for a living, I probably wouldn't
              have believed you. Here's the thing though: I've always loved art
              and drawing. Creating things visually, making something look just
              right — that's always been my thing.
            </p>

            <p className="font-body text-charcoal/80 leading-relaxed text-[15px] mb-4">
              When I discovered development, something clicked.{" "}
              <span style={{ color: "#4a5230", fontWeight: 600 }}>
                You write code and you actually see what you build.
              </span>{" "}
              It's like digital art — but with logic underneath. That's what
              caught my eye and honestly, never let go. Was it confusing at
              first? Absolutely. There were days I had no idea what I was doing.
              But I kept going, and now? I genuinely love what I do.
            </p>

            <p className="font-body text-charcoal/80 leading-relaxed text-[15px] mb-6">
              Outside of coding you'll find me doing content creation — makeup,
              lifestyle, product reviews, the whole thing. I like to keep myself
              busy and always be learning something new. Whether it's a new
              framework, a new editing style, or a new way to talk to a camera —
              I'm always adding something to the mix. That curiosity is what
              keeps me growing, both as a developer and as a person.
            </p>
              ...
              {stats.map((s) => (
                <div
                  ...
                  style={{
                    ...
                    padding: "12px 10px",
                    textAlign: "center",
                    background: "rgba(107,118,69,0.04)",
                  }}
                >
                  <div
                    style={{
                  ...
                  <div className="font-mono text-[10px] text-charcoal/50 mt-1 uppercase tracking-wider">
                    {s.label}
                  </div>
                </div>
              ))}
            ...
            {/* Skills */}
            <div className="mb-6">
              <p className="font-mono text-olive text-xs uppercase tracking-widest mb-3">
                // Skills
              </p>
            ...
            >
              <p className="font-mono text-xs text-olive-dark">
                ✨ Beyond code → makeup tutorials, product reviews, lifestyle
                vlogs & shopping hauls on Instagram & YouTube
              </p>
            </div>
          </div>
        </motion.div>
